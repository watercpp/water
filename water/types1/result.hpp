...
#ifndef WATER_TYPES1_RESULT_HPP
#define WATER_TYPES1_RESULT_HPP
#include <water/types1/type.hpp>
#include <water/types1/integer.hpp>
...
is a typedef of types1::result_tag is seen as a result. That enables nesting.
...
// result a_::result_tag if it exsists and is a types1::result_tag, else void
// - result_tag_of<type<int> >::result is types1::result_tag<types1::type_kind> >
...
// - result_kind_of<type<int> >::result is types1::type_kind
// - result_kind_of<enum_result<123> >::result is types1::integer_kind
...
// - result_kind<enum_result<123> > inherits types1::integer_kind
