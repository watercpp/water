...
#ifndef WATER_TYPES1_TESTS_LINK_HPP
#define WATER_TYPES1_TESTS_LINK_HPP
#include <water/types1/link.hpp>
...
namespace link_hpp {
    ...
    int constexpr assert1 =
        ...
        type_assert<equal_plain<types1::pull<l2>::result, link<int, link<void> > > >::assert +
