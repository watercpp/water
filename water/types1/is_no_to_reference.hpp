...
#ifndef WATER_TYPES1_IS_NO_TO_REFERENCE_HPP
#define WATER_TYPES1_IS_NO_TO_REFERENCE_HPP
...
namespace _ {
    ...
    template<typename>
    struct do_is_reference : false_result {};
    
    template<typename a_>
    struct do_is_reference<a_&> : true_result {};
    ...
    template<typename a_>
    struct do_no_reference : type_plain<a_> {};
    
    template<typename a_>
    struct do_no_reference<a_&> : type_plain<a_> {};
    ...
    template<typename a_>
    struct do_to_reference : type_plain<a_&> {};
    
    template<typename a_>
    struct do_to_reference<a_&> : type_plain<a_&> {};
