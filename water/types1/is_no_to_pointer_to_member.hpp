...
#ifndef WATER_TYPES1_IS_NO_TO_POINTER_TO_MEMBER_HPP
#define WATER_TYPES1_IS_NO_TO_POINTER_TO_MEMBER_HPP
...
//
// use types1::is_pointer_to_member_function to find out if it's a member
