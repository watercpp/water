...
#ifndef WATER_TYPES1_PULL_HPP
#define WATER_TYPES1_PULL_HPP
...
namespace _ {
    ...
    template<typename k_, typename c_, typename = void>
    struct do_pull :
        type_plain<c_>
    {};
    
    template<typename k_, typename c_>
    struct do_pull<k_, c_, to_void<typename k_::template pull<void> >> :
        k_::template pull<c_>
    {};
...
namespace _ {
    ...
    struct do_pull_exists :
        false_result
    {};
    
    template<typename a_>
    struct do_pull_exists<a_, to_void<typename a_::template pull<void> >> :
        true_result
    {};
