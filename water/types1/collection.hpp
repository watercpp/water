...
#ifndef WATER_TYPES1_COLLECTION_HPP
#define WATER_TYPES1_COLLECTION_HPP
...
// result a_::collection_tag if it exists and is a typedef of types1::collecion_tag, else void
template<typename a_>
