...
class name_assign {
	...
	public:
		...
		name_assign(name& a) noexcept : my(&a) {}
		template<typename iterator_> void operator()(iterator_ begin, iterator_ end) const noexcept { if(my) my->assign(begin, end); }
		template<typename iterator_> void operator()(iterator_ begin, size_t size) const noexcept { if(my) my->assign(begin, size); }
		void operator()(char const* cstring) const noexcept { if(my) my->assign(cstring); }
	};
