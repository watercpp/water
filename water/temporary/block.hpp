...
template<typename allocator_, typename sizer_> block*
 allocate_block(allocator_* allocator, block* list, size_t bytes, sizer_ const& sizer) noexcept(allocator_noexcept<allocator_>()) {
...
template<typename allocator_> block*
 free_block(allocator_* allocator, block* list) noexcept {
...
template<typename allocator_> void
 free_all_blocks(allocator_* allocator, block* list) noexcept {
...
template<typename allocator_> block*
 free_unused_blocks(allocator_* allocator, block* list) noexcept {
...
template<typename allocator_> block*
 free_unused_blocks(allocator_* allocator, block* list, unsigned keep) noexcept {
...
template<typename sizer_> block*
 allocate_block(void*, block*, size_t, sizer_ const&) noexcept {
 	return 0;
 	}

inline block*
 free_block(void*, block* list) noexcept {
	return list;
	}

inline void
 free_all_blocks(void*, block*) noexcept {
	}
	
inline block*
 free_unused_blocks(void*, block* list, unsigned = 0) noexcept {
 	return list;
 	}

inline block*
 block_from_memory(block* list, void* memory, size_t bytes) noexcept {
...
inline block*
 find(block* list, void const* pointer) noexcept {
...
inline block*
 find_smallest_unused(block* list) noexcept {
...
inline size_t
 release(block*& list, void const* pointer) noexcept {
...
inline size_t
 release(temporary::block* block) noexcept {
...
inline size_t
 retain(block*& list, void const* pointer) noexcept {
...
inline size_t
 retain(temporary::block* block) noexcept {
...
template<typename allocator_, typename sizer_> void*
 push(block*& list, size_t bytes, size_t align, unsigned allocate_block_and_keep, allocator_* allocator, sizer_ const& sizer) noexcept(allocator_noexcept<allocator_>()) {
...
template<typename allocator_, typename sizer_> void*
 push_at_least(block*& list, size_t& pushed, size_t at_least, size_t multiply, size_t align, unsigned allocate_block_and_keep, allocator_* allocator, sizer_ const& sizer) noexcept(allocator_noexcept<allocator_>()) {
...
inline void
 pop(block*& list, void const* pointer, size_t bytes) noexcept {
...
inline void
 pop(block*& list, void const* begin, void const* end) noexcept {
...
inline void*
 resize(block*& list, void const* pointer, size_t old_size, size_t new_size) noexcept {
