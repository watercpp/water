...
#ifndef WATER_ATOMIC_OLD_ATOMIC_TAG_HPP
#define WATER_ATOMIC_OLD_ATOMIC_TAG_HPP
...
// result true if a_::atomic_tag exists and is a typedef of atomic_old::atomic_tag
template<typename a_> struct
...
// result
// - a_::atomic_type if atomic_old::has_atomic_tag<a_>
// - else a_ 
template<typename a_> struct
...
// result
// - a_::value_type if atomic_old::has_atomic_tag<a_>
// - else a_ 
template<typename a_> struct
