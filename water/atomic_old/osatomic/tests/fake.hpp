...
#ifndef WATER_ATOMIC_OLD_OSATOMIC_TESTS_FAKE_HPP
#define WATER_ATOMIC_OLD_OSATOMIC_TESTS_FAKE_HPP
#include <water/types/types.hpp>
#include <water/int.hpp>
#include <water/atomic_old/tests/fake/fake.hpp>
namespace water { namespace atomic_old { namespace osatomic {
...
typedef types::if_not_void<atomic_old::int_bits<32>, water::int_bits_at_least<32> >::result int32_t;
typedef types::if_not_void<atomic_old::int_bits<64>, water::int_bits_at_least<64> >::result int64_t;
