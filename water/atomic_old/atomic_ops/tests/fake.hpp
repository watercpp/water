...
#define WATER_ATOMIC_OLD_ATOMIC_OPS_TESTS_FAKE_HPP
...
typedef types::ifel<
	...
	unsigned long,
	types::if_not_void<
		atomic_old::uint_size<sizeof(void*)>,
...
#define WATER_ATOMIC_OLD_ATOMIC_OPS_fake(prefix) \
...
WATER_ATOMIC_OLD_ATOMIC_OPS_fake(_)
WATER_ATOMIC_OLD_ATOMIC_OPS_fake(_int_)
WATER_ATOMIC_OLD_ATOMIC_OPS_fake(_short_)
WATER_ATOMIC_OLD_ATOMIC_OPS_fake(_char_)
#undef WATER_ATOMIC_OLD_ATOMIC_OPS_fake
