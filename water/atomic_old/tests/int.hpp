...
#if !defined(WATER_ATOMIC_OLD_TESTS_INT_HPP) || defined(WATER_ATOMIC_OLD_INLINE)
#ifndef WATER_ATOMIC_OLD_INLINE
#define WATER_ATOMIC_OLD_TESTS_INT_HPP
...
test atomic_old/int.hpp, stolen from water/int.hpp test
