...
#if !defined(WATER_ATOMIC_OLD_TESTS_INFO_HPP) || defined(WATER_ATOMIC_OLD_INLINE)
#ifndef WATER_ATOMIC_OLD_INLINE
#define WATER_ATOMIC_OLD_TESTS_INFO_HPP
...
using water::atomic_old::tests::barrier_name;
#endif
...
template<typename o_> void
 info(str::out<o_>& o, unsigned s = 0) {
	...
	o << str::repeat(' ', s) << "water::atomic_old::tests::info\n\n";
	s += 2;
