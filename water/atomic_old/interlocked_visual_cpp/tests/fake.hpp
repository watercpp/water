...
#ifndef WATER_ATOMIC_OLD_INTERLOCKED_VISUAL_CPP_TESTS_FAKE_HPP
#define WATER_ATOMIC_OLD_INTERLOCKED_VISUAL_CPP_TESTS_FAKE_HPP
#include <water/types/types.hpp>
#include <water/int.hpp>
#include <water/atomic_old/tests/fake/fake.hpp>
namespace water { namespace atomic_old { namespace interlocked_visual_cpp {
...
namespace fake = atomic_old::tests::fake;

typedef types::if_not_void<atomic_old::int_bits<16>, water::int_bits_at_least<16> >::result i16_t;
typedef types::if_not_void<atomic_old::int_bits<32>, water::int_bits_at_least<32> >::result i32_t;
typedef types::if_not_void<atomic_old::int_bits<64>, water::int_bits_at_least<64> >::result i64_t;
