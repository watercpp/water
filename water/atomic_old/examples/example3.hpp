...
#ifndef WATER_ATOMIC_OLD_EXAMPLES_EXAMPLE3_HPP
#define WATER_ATOMIC_OLD_EXAMPLES_EXAMPLE3_HPP
#include <water/atomic_old/constants.hpp>
#include <water/types/types.hpp>
namespace water { namespace atomic_old { namespace example3 {

/*

This example only has the atomic_old::add_get operation

water::atomic_old can use this to make get and the various add and subtract functions. it cannot make set,
