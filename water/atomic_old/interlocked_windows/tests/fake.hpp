...
#ifndef WATER_ATOMIC_OLD_INTERLOCKED_WINDOWS_TESTS_FAKE_HPP
#define WATER_ATOMIC_OLD_INTERLOCKED_WINDOWS_TESTS_FAKE_HPP
#include <water/types/types.hpp>
#include <water/int.hpp>
#include <water/atomic_old/tests/fake/fake.hpp>
namespace water { namespace atomic_old { namespace interlocked_windows {
...
size_t const bits32 = 32
	#ifdef WATER_ATOMIC_OLD_INTERLOCKED_TESTS_FAKE_64
	- 16
	#endif
	;

typedef types::if_not_void<atomic_old::int_bits<bits32>, water::int_bits_at_least<bits32> >::result a32_t, LONG;
typedef types::if_not_void<atomic_old::int_bits<bits32 * 2>, water::uint_bits_at_least<bits32 * 2> >::result a64_t, LONGLONG;
