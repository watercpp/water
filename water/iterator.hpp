...
namespace _ {
	template<typename a_, typename = void> struct
	 do_iterator_category :
		types::type_plain<void>
			{};
	template<typename a_> struct
	 do_iterator_category<a_, types::to_void<typename a_::iterator_category>> :
		types::type_plain<typename a_::iterator_category>
			{};
	template<typename a_> struct
	 do_iterator_category<a_*, void> :
		types::type_plain<random_access_iterator_tag>
			{};
	
	template<typename tag_, typename category_of_, typename = void> struct
	 do_is_iterator_category :
		types::false_result
			{};
	template<typename tag_, typename category_of_> struct
	 do_is_iterator_category<tag_, category_of_, types::to_void<decltype(types::make<tag_*&>() = types::make<category_of_*>())>> :
		types::true_result
			{};
	}
...
namespace _ {
	template<typename a_, typename = void> struct
	 do_iterator_value_type_2 :
		types::type_plain<void>
			{};
	template<typename a_> struct
	 do_iterator_value_type_2<a_, types::to_void<decltype(*types::make<a_&>())>> :
		types::no_reference<types::no_const<decltype(*types::make<a_&>())>>
			{};
	
	template<typename a_, typename = void> struct
	 do_iterator_value_type :
		do_iterator_value_type_2<a_>
			{};
	template<typename a_> struct
	 do_iterator_value_type<a_, types::to_void<typename a_::value_type>> :
		types::no_const<typename a_::value_type>
			{};
	template<typename a_> struct
	 do_iterator_value_type<a_*, void> :
		types::no_const<a_>
			{};
	
	template<typename a_, typename = void> struct
	 do_iterator_difference_type_2 :
		types::type_plain<void>
			{};
	template<typename a_> struct
	 do_iterator_difference_type_2<a_, types::to_void<decltype(types::make<a_&>() - types::make<a_&>())>> :
		types::type_plain<decltype(types::make<a_&>() - types::make<a_&>())>
			{};
	
	template<typename a_, typename = void> struct
	 do_iterator_difference_type :
		do_iterator_difference_type_2<a_>
			{};
	template<typename a_> struct
	 do_iterator_difference_type<a_, types::to_void<typename a_::difference_type>> :
		types::type_plain<typename a_::difference_type>
			{};
	template<typename a_> struct
	 do_iterator_difference_type<a_*, void> :
		types::type_plain<ptrdiff_t>
			{};
	
	template<typename a_, typename = void> struct
	 do_iterator_pointer_2 :
		types::type_plain<void>
			{};
	template<typename a_> struct
	 do_iterator_pointer_2<a_, types::to_void<decltype(types::make<a_&>().operator->())>> :
	...
	template<typename a_, typename = void> struct
	 do_iterator_pointer :
		do_iterator_pointer_2<a_>
			{};
	template<typename a_> struct
	 do_iterator_pointer<a_, types::to_void<typename a_::pointer>> :
		types::type_plain<typename a_::pointer>
			{};
	template<typename a_> struct
	 do_iterator_pointer<a_*, void> :
		types::type_plain<a_*>
			{};
	
	template<typename a_, typename = void> struct
	 do_iterator_reference_2 :
		types::type_plain<void>
			{};
	template<typename a_> struct
	 do_iterator_reference_2<a_, types::to_void<decltype(*types::make<a_&>())>> :
		types::type_plain<decltype(*types::make<a_&>())>
			{};
	
	template<typename a_, typename = void> struct
	 do_iterator_reference :
		do_iterator_reference_2<a_>
			{};
	template<typename a_> struct
	 do_iterator_reference<a_, types::to_void<typename a_::reference>> :
		types::type_plain<typename a_::reference>
			{};
	template<typename a_> struct
	 do_iterator_reference<a_*, void> :
		types::type_plain<a_&>
			{};
	
	template<typename a_, typename = void> struct
	 do_iterator_is_const :
		types::true_result
			{};
	template<typename a_> struct
	 do_iterator_is_const<a_, types::to_void<decltype(*types::make<a_&>() = types::make<typename do_iterator_value_type<a_>::result&&>())>> :
		types::false_result
			{};
	}
...
template<typename type_> type_* iterator_pointer(type_ *a) {
	return a;
	}

template<typename iterator_> auto iterator_pointer(iterator_&& a) -> decltype(a.operator->()) {
	return a.operator->();
	}
