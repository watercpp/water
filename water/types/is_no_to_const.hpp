...
namespace _ {
	template<typename> struct do_is_const : false_result {};
	template<typename a_> struct do_is_const<a_ const> : true_result {};
	template<typename a_> struct do_is_const<a_ const&> : true_result {};
	template<typename a_> struct do_is_const<a_ const&&> : true_result {};
	
	template<typename a_> struct do_no_const : type_plain<a_> {};
	template<typename a_> struct do_no_const<a_ const> : type_plain<a_> {};
	template<typename a_> struct do_no_const<a_ const&> : type_plain<a_&> {};
	template<typename a_> struct do_no_const<a_ const&&> : type_plain<a_&&> {};
	
	template<typename a_> struct do_to_const : type_plain<a_ const> {};
	template<typename a_> struct do_to_const<a_ const> : type_plain<a_ const> {};
	template<typename a_> struct do_to_const<a_&> : type_plain<a_ const&> {};
	template<typename a_> struct do_to_const<a_ const&> : type_plain<a_ const&> {};
	template<typename a_> struct do_to_const<a_&&> : type_plain<a_ const&&> {};
	template<typename a_> struct do_to_const<a_ const&&> : type_plain<a_ const&&> {};
	}
