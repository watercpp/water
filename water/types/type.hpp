...
namespace _ {
	...
	template<typename a_, typename b_> struct
	 type_kind_equal : type_kind_bool<false>
	 	{};
	template<typename a_> struct
	 type_kind_equal<a_, a_> : type_kind_bool<true>
	 	{};
	}

struct type_kind {
	template<typename a_, typename b_> struct
	 equal : _::type_kind_equal<typename a_::result, typename b_::result>
		{};
	template<typename a_> struct
	 type : a_
		{};
...
namespace _ {
	...
	template<typename r_> struct
	 do_type_result<r_, typename r_::result_tag, void, true> {
		typedef typename r_::result result;
		};
	template<typename r_> struct
	 do_type_result<r_, typename r_::result_tag, void, false> :
		do_type_result<r_, void, typename r_::result_tag, false>
			{};
	template<typename r_> struct
	 do_type_result<r_, void, result_tag<type_kind>, false> {
		typedef typename r_::result result;
		};
	}
