...
template<typename kind_ /*= void*/> struct
 result_tag :
	type_plain<kind_>
		{};
...
namespace _ {
	...
	template<typename x_ = void> struct
	 do_result_tag_to_void {
		typedef void result;
		};
	
	template<template<typename> class to_, typename from_, typename x_ = void> struct
	 do_result_tag_to :
		to_<void>
			{};
	template<template<typename> class to_, typename from_> struct
	 do_result_tag_to<to_, from_, typename do_result_tag_to_void<typename from_::result_tag>::result> :
	...
	template<typename k_> struct
	 do_is_result<result_tag<k_> > :
		true_result
			{};
	template<> struct
	 do_is_result<result_tag<> > :
		false_result
			{};
	...
	template<typename t_> struct
	 do_result_tag_of :
		type_plain<void>
			{};
	template<typename k_> struct
	 do_result_tag_of<result_tag<k_> > :
	...
	template<typename t_> struct
	 do_result_kind_of :
		type_plain<void>
			{};
	template<typename k_> struct
	 do_result_kind_of<result_tag<k_> > :
		type_plain<k_>
			{};
	...
	template<typename t_> struct
	 do_result_kind
		{};
	template<typename k_> struct
	 do_result_kind<result_tag<k_> > :
		k_
			{};
	template<> struct
	 do_result_kind<result_tag<> >
		{};
