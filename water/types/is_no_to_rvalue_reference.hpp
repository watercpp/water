...
#ifndef WATER_TYPES_IS_NO_TO_RVALUE_REFERENCE_HPP
#define WATER_TYPES_IS_NO_TO_RVALUE_REFERENCE_HPP
#include <water/types/result.hpp>
namespace water { namespace types {

namespace _ {
	template<typename> struct do_is_rvalue_reference : false_result {};
	template<typename a_> struct do_is_rvalue_reference<a_&&> : true_result {};
	
	template<typename a_> struct do_no_rvalue_reference : type_plain<a_> {};
	template<typename a_> struct do_no_rvalue_reference<a_&&> : type_plain<a_> {};
	
	template<typename a_> struct do_to_rvalue_reference : type_plain<a_&&> {};
	template<typename a_> struct do_to_rvalue_reference<a_&> : type_plain<a_&&> {};
	template<typename a_> struct do_to_rvalue_reference<a_&&> : type_plain<a_&&> {};
	}
