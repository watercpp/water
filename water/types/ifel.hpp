...
template<bool if_, typename true_, typename false_ = nothing> struct
 ifel :
	any_result<true_>
		{};
template<typename true_, typename false_> struct
 ifel<false, true_, false_> :
	any_result<false_>
		{};
template<typename false_> struct
 ifel<true, nothing, false_> :
 	any_result<>
		{};
template<typename true_> struct
 ifel<false, true_, nothing> :
 	any_result<>
		{};
template<bool if2_, typename true2_, typename false2_, typename false_> struct
 ifel<true, ifel<if2_, true2_, false2_>, false_> :
	ifel<if2_, true2_, false2_>
		{};
template<typename true_, bool if2_, typename true2_, typename false2_> struct
 ifel<false, true_, ifel<if2_, true2_, false2_> > :
	ifel<if2_, true2_, false2_>
		{};

// ifel_type is like types::ifel<types::to_bool<if_>::result, true_, false_>
template<typename if_, typename true_, typename false_ = nothing> struct
 ifel_type :
...
template<bool if_, typename true_, typename false_ = nothing> struct
 ifel_plain :
 	type_plain<true_>
 		{};
template<typename true_, typename false_> struct
 ifel_plain<false, true_, false_> :
 	type_plain<false_>
 		{};
template<typename false_> struct
 ifel_plain<true, nothing, false_> :
 	any_result<>
		{};
template<typename true_> struct
 ifel_plain<false, true_, nothing> :
 	any_result<>
		{};
