...
template<typename iterator_, bool make_const_, bool proxy_> struct
 select_reference_pointer {
...
template<typename iterator_, bool make_const_> struct
 select_reference_pointer<iterator_, make_const_, false> {
