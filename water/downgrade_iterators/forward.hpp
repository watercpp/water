...
template<typename iterator_> forward<iterator_> forward_from(iterator_ const& a) {
	return forward<iterator_>{a};
	}

template<typename iterator_> forward_const<iterator_> forward_const_from(iterator_ const& a) {
	return forward_const<iterator_>{a};
	}

template<typename iterator_> forward_proxied<iterator_> forward_proxied_from(iterator_ const& a) {
	return forward_proxied<iterator_>{a};
	}

template<typename iterator_> forward_proxied_const<iterator_> forward_proxied_const_from(iterator_ const& a) {
