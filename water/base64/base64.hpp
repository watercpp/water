...
void encode(to_ to, void const *from, size_t bytes) {
...
template<typename to_>
size_t decode(to_ to, void const *from, size_t bytes, bool more = false) {
    // to(byte)
    //
    // returns
