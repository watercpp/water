...
out<out<p_, w_>, write_float<float, typename out<p_, w_>::number_format>> operator<<(
    out<p_, w_> const& o,
    float a
) {
    return {o, a};
...
template<typename p_, typename w_>
out<out<p_, w_>, write_float<double, typename out<p_, w_>::number_format>> operator<<(
    out<p_, w_> const& o,
    double a
) {
    return {o, a};
...
template<typename p_, typename w_>
out<out<p_, w_>, write_float<long double, typename out<p_, w_>::number_format>> operator<<(
    out<p_, w_> const& o,
    long double a
) {
    return {o, a};
