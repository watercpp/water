...
template<typename iterator_> struct write_range_select_utf<iterator_, true> { using result = void; };
...
template<typename char_, typename settings_> class
 write_utf_char<char_, settings_, false> : public write_char {
	public:
		write_utf_char(char_ a) : write_char(static_cast<char>(a)) {}
	};

template<typename char_> struct utf_char_const_pointer {
	char_ const *pointer;
...
template<typename p_, typename w_> out<out<p_, w_>, write_utf_char<char32_t, typename out<p_, w_>::settings>>
 operator<<(out<p_, w_> const& o, char32_t a) {
	return {o, a};
	}

template<typename p_, typename w_> out<out<p_, w_>, write_utf_char<wchar_t, typename out<p_, w_>::settings>>
 operator<<(out<p_, w_> const& o, wchar_t a) {
	return {o, a};
	}

template<typename p_, typename w_, unsigned size_> out<out<p_, w_>, write_utf_string<char16_t const*, typename out<p_, w_>::settings, 3 * size_, 16>>
 operator<<(out<p_, w_> const& o, char16_t const (&a)[size_]) {
	return {o, {a, a + size_}};
	}

template<typename p_, typename w_, unsigned size_> out<out<p_, w_>, write_utf_string<char32_t const*, typename out<p_, w_>::settings, 4 * size_, 32>>
 operator<<(out<p_, w_> const& o, char32_t const (&a)[size_]) {
	return {o, {a, a + size_}};
	}

template<typename p_, typename w_, unsigned size_> out<out<p_, w_>, write_utf_string<wchar_t const*, typename out<p_, w_>::settings, (wchar_utf == 16 ? 3 * size_ : 4 * size_), wchar_utf>> // keep parenthesis because vc++
 operator<<(out<p_, w_> const& o, wchar_t const (&a)[size_]) {
	return {o, {a, a + size_}};
	}

template<typename p_, typename w_> out<out<p_, w_>, write_utf_string<char16_t const*, typename out<p_, w_>::settings, 0, 16> >
 operator<<(out<p_, w_> const& o, utf_char_const_pointer<char16_t> a) {
	return {o, {a.pointer}};
	}

template<typename p_, typename w_> out<out<p_, w_>, write_utf_string<char32_t const*, typename out<p_, w_>::settings, 0, 32> >
 operator<<(out<p_, w_> const& o, utf_char_const_pointer<char32_t> a) {
	return {o, {a.pointer}};
	}

template<typename p_, typename w_> out<out<p_, w_>, write_utf_string<wchar_t const*, typename out<p_, w_>::settings, 0, wchar_utf> >
 operator<<(out<p_, w_> const& o, utf_char_const_pointer<wchar_t> a) {
	return {o, {a.pointer}};
	}
