...
namespace _ {
	...
	template<typename type_> char* type_name_copy(char *tb, char *te, unsigned& pos) {
	...
	template<typename type_, typename function_> void type_name_do(function_& function) {
		char c[256], *e;
		unsigned p = 0;
		bool any = false;
		do {
...
template<typename type_, typename function_> void type_name_to(function_&& function) {
