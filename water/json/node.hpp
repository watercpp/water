...
template<typename memory_, typename other_, typename result_>
struct node_if_no_memory {};

template<typename other_, typename result_>
struct node_if_no_memory<void, other_, result_> { using result = result_; };

template<typename result_>
struct node_if_no_memory<void, void, result_> {};
...
//
template<typename memory_ = void>
class node
{
...
public:
    ...
    node(node<other_> a, typename node_if_no_memory<memory_, other_, nothing>::result = {}) :
        mym{0},
        my{a.my}
    {}
