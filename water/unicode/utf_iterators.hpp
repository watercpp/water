...
utf_iterator_with_end<to_, iterator_, verify_, from_> end(utf_iterator_with_end<to_, iterator_, verify_, from_> const&) {
    return {};
}
...
template<unsigned to_, typename iterator_, bool verify_, unsigned from_>
utf_iterator_with_size<to_, iterator_, verify_, from_> end(utf_iterator_with_size<to_, iterator_, verify_, from_> const&) {
    return {};
}
...
utf_iterator_with_end<to_, char_ const*> utf_iterator_from_cstring(char_ const* cstring) {
    auto end = cstring;
...
utf_iterator_with_end<to_, iterator_> utf_iterator_from(iterator_ begin, iterator_ end) {
    return {begin, end};
}

template<unsigned to_, typename iterator_>
utf_iterator_with_size<to_, iterator_> utf_iterator_from(iterator_ begin, size_t size) {
    return {begin, size};
}
