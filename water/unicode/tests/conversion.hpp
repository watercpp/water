...
#ifndef WATER_UNICODE_TESTS_CONVERSION_HPP
#define WATER_UNICODE_TESTS_CONVERSION_HPP
...
struct conversion
{
    ...
    conversion() {
        ...
        do {
            ...
            // 8 from 32
            auto a8e = utf_from_utf_verify<8, 32, true>(static_cast<uchar_t*>(a8), static_cast<char32_t const*>(original), 0x100);
            auto b8e = utf_from_utf_verify<8, 32, false>(static_cast<uchar_t*>(b8), static_cast<char32_t const*>(original), 0x100);
            ___water_test(a8 + a8e.size() == a8e.end());
            ___water_test(b8 + b8e.size() == b8e.end());
            ___water_test(equal(a8 + 0, a8e.end(), b8 + 0, b8e.end()));
            auto l8 = utf_length<8>(static_cast<uchar_t const*>(a8), a8e.size());
            ___water_test(length_test(length, l8, original[0]));
            l8 = utf_length<8>(static_cast<uchar_t const*>(b8), static_cast<uchar_t const*>(b8e.end()));
            ___water_test(length_test(length, l8, original[0]));
            {
            ...
            // 8 from 16
            a8e = utf_from_utf_verify<8, 16, true>(static_cast<uchar_t*>(a8), static_cast<char16_t const*>(a16), length.utf16());
            b8e = utf_from_utf_verify<8, 16, false>(static_cast<uchar_t*>(b8), static_cast<char16_t const*>(a16), length.utf16());
            ___water_test(a8 + a8e.size() == a8e.end());
            ___water_test(b8 + b8e.size() == b8e.end());
            ___water_test(equal(a8 + 0, a8e.end(), b8 + 0, b8e.end()));
            l8 = utf_length<8>(static_cast<uchar_t const*>(a8), a8e.size());
            ___water_test(length_test(length, l8, original[0]));
            l8 = utf_length<8>(static_cast<uchar_t const*>(b8), static_cast<uchar_t const*>(b8e.end()));
            ___water_test(length_test(length, l8, original[0]));
            {
            ...
            // 16 from 8
            a16e = utf_from_utf_verify<16, 8, true>(static_cast<char16_t*>(a16), static_cast<uchar_t const*>(a8), length.utf8());
            b16e = utf_from_utf_verify<16, 8, false>(static_cast<char16_t*>(b16), static_cast<uchar_t const*>(a8), length.utf8());
            ___water_test(a16 + a16e.size() == a16e.end());
            ___water_test(b16 + b16e.size() == b16e.end());
            ___water_test(equal(a16 + 0, a16e.end(), b16 + 0, b16e.end()));
            ...
            ___water_test(length_test(length, l16, original[0]));
            {
                auto i = utf_iterator_with_end<16, uchar_t const*, true>(a8, a8 + length.utf8());
                ___water_test(equal(a16 + 0, a16e.end(), i, end(i)));
                auto l = utf_length<16>(i, end(i));
                ___water_test(length_test(length, l, original[0]));
            }
            {
                auto i = utf_iterator_with_end<16, uchar_t const*, false>(a8, a8 + length.utf8());
                ___water_test(equal(a16 + 0, a16e.end(), i, end(i)));
                auto l = utf_length<16>(i, end(i));
                ___water_test(length_test(length, l, original[0]));
            }
            {
                auto i = utf_iterator_with_size<16, uchar_t const*, true>(a8, length.utf8());
                ___water_test(equal(a16 + 0, a16e.end(), i, end(i)));
                auto l = utf_length<16>(i, length.utf16());
                ___water_test(length_test(length, l, original[0]));
            }
            {
                auto i = utf_iterator_with_size<16, uchar_t const*, false>(a8, length.utf8());
                ___water_test(equal(a16 + 0, a16e.end(), i, end(i)));
                auto l = utf_length<16>(i, length.utf16());
                ___water_test(length_test(length, l, original[0]));
            }
            ...
            // 32 from 8
            auto a32e = utf_from_utf_verify<32, 8, true>(static_cast<char32_t*>(a32), static_cast<uchar_t const*>(a8), length.utf8());
            auto b32e = utf_from_utf_verify<32, 8, false>(static_cast<char32_t*>(b32), static_cast<uchar_t const*>(a8), length.utf8());
            ...
            ___water_test(length_test(length, l32, original[0]));
            {
                auto i = utf_iterator_with_end<32, uchar_t const*, true>(a8, a8 + length.utf8());
                ___water_test(equal(a32 + 0, a32e.end(), i, end(i)));
                auto l = utf_length<32>(i, end(i));
                ___water_test(length_test(length, l, original[0]));
            }
            {
                auto i = utf_iterator_with_end<32, uchar_t const*, false>(a8, a8 + length.utf8());
                ___water_test(equal(a32 + 0, a32e.end(), i, end(i)));
                auto l = utf_length<32>(i, end(i));
                ___water_test(length_test(length, l, original[0]));
            }
            {
                auto i = utf_iterator_with_size<32, uchar_t const*, true>(a8, length.utf8());
                ___water_test(equal(a32 + 0, a32e.end(), i, end(i)));
                auto l = utf_length<32>(i, length.utf32());
                ___water_test(length_test(length, l, original[0]));
            }
            {
                auto i = utf_iterator_with_size<32, uchar_t const*, false>(a8, length.utf8());
                ___water_test(equal(a32 + 0, a32e.end(), i, end(i)));
                auto l = utf_length<32>(i, length.utf32());
                ___water_test(length_test(length, l, original[0]));
            }
    ...
    downgrade_iterators::forward<iterator_> forward(iterator_ a) {
    ...
    template<unsigned a_, unsigned b_>
    bool length_test(utf_length<a_> a, utf_length<b_> b, char32_t c) {
        if(!a || !b)
            return false;
