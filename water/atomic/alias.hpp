...
#if !defined(WATER_ATOMIC_ALIAS_HPP) || defined(WATER_ATOMIC_INLINE)
#ifndef WATER_ATOMIC_INLINE
#define WATER_ATOMIC_ALIAS_HPP
...
//
// if atomic::compare_set does not exist for all types the underlying
...
template<typename type_> struct
 alias {
	typedef ::water::atomic::atomic_tag atomic_tag;
