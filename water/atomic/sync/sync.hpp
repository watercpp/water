...
#define WATER_ATOMIC_SYNC_SYNC_HPP
...
unsigned constexpr has_size = 0
	#if defined(__GCC_HAVE_SYNC_COMPARE_AND_SWAP_1) && !defined(WATER_ATOMIC_SYNC_NO_1)
	| 1
	#endif
	#if defined(__GCC_HAVE_SYNC_COMPARE_AND_SWAP_2) && !defined(WATER_ATOMIC_SYNC_NO_2)
	| 2
	#endif
	#if defined(__GCC_HAVE_SYNC_COMPARE_AND_SWAP_4) && !defined(WATER_ATOMIC_SYNC_NO_4)
	| 4
	#endif
	#if defined(__GCC_HAVE_SYNC_COMPARE_AND_SWAP_8) && !defined(WATER_ATOMIC_SYNC_NO_8)
	| 8
	#endif
	#if defined(__GCC_HAVE_SYNC_COMPARE_AND_SWAP_16) && !defined(WATER_ATOMIC_SYNC_NO_16)
	| 16
	#endif
	#ifdef WATER_ATOMIC_SYNC_TESTS_FAKE_HPP
	| 1 | 2 | 4 | 8 | 16
	#endif
	;
...
using sync16_t =
	#if defined(__SIZEOF_INT128__) && __SIZEOF_INT128__ == 16 && defined(__GCC_HAVE_SYNC_COMPARE_AND_SWAP_16) && !defined(WATER_ATOMIC_SYNC_NO_16)
	__int128;
	#else
