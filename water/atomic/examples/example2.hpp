...
#ifndef WATER_ATOMIC_EXAMPLES_EXAMPLE2_HPP
#define WATER_ATOMIC_EXAMPLES_EXAMPLE2_HPP
#include <water/atomic/constants.hpp>
#include <water/types/types.hpp>
namespace water { namespace atomic { namespace example2 {

/*

This example has a special atomic::compare_set operation that can atomically modify something with sizeof(long[2]).
...
// water::atomic cannot use arrays. this struct is needed to make compare_and_swap_two work with water::atomic.
//
// water::atomic needs structs like this to...
// - have == and != operators
// - be a pod struct
