...
#define WATER_ATOMIC_ATOMIC_OPS_ATOMIC_OPS_HPP
#include <water/atomic/atomic_ops/compare_and_swap.hpp>
#include <water/atomic/atomic_ops/fetch_and_add.hpp>
#include <water/atomic/atomic_ops/fetch_and_add1.hpp>
#include <water/atomic/atomic_ops/fetch_and_sub1.hpp>
#include <water/atomic/atomic_ops/load.hpp>
#include <water/atomic/atomic_ops/store.hpp>
