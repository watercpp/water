...
template<typename limits_, bool is_specialized_ = limits_::is_specialized> struct
 numeric_limits_to_str_values {
 	template<typename o_> static void do_it(str::out<o_>& o) {
...
template<typename limits_> struct
 numeric_limits_to_str_values<limits_, false> {
	template<typename o_> static void do_it(str::out<o_>&) {}
	};


template<typename o_, typename limits_> void numeric_limits_to_str(str::out<o_>& o, limits_) {
...
template<template<typename> class make_, typename o_> void numeric_limits_to_str(str::out<o_>& o) {
...
template<typename type_> struct
 numeric_limits_to_str_make_std {
	using result = numeric_limits<type_>;
	};

template<typename type_> struct
 numeric_limits_to_str_make_water {
	using result = no_numeric_limits<type_>;
	};

template<typename o_> void numeric_limits_to_str_std(str::out<o_>& o) {
	numeric_limits_to_str<numeric_limits_to_str_make_std>(o);
	}

template<typename o_> void numeric_limits_to_str_water(str::out<o_>& o) {
