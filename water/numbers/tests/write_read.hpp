...
void write_read_float(settings s) {
    ...
    float_ const floats[] = {
        ...
        cast<float_>(-1.010101010101010101010101010101010101010101010101010101010101010l),
        cast<float_>(-1.010101010101010101010101010101010101010101010101010101010101010e-20l),
        cast<float_>(9.09090909090909090909090909090909090909090909090909090909l),
        cast<float_>(9.09090909090909090909090909090909090909090909090909090909e20l),
        cast<float_>(3.141592653589793238462643383279502884197169399375l),
