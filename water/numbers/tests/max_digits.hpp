...
template<typename out_> void max_digits_make_log2_lookup(out_&& o, unsigned bits = 16, unsigned size = 32) {
...
namespace std {
	...
	template<int radix_, int digits_, bool integer_, bool signed_> class
	 numeric_limits<water::numbers::tests::max_digits_t<radix_, digits_, integer_, signed_> > {
		public:
...
template<unsigned radix_, unsigned digits_max_, unsigned digits_ = 1, bool end_ = !(digits_ <= digits_max_)> struct
 max_digits_test_radix {
	static void do_it() {
...
template<unsigned radix_, unsigned digits_max_, unsigned digits_> struct
 max_digits_test_radix<radix_, digits_max_, digits_, true> {
	static void do_it() {}
	};

template<unsigned radix_max_, unsigned digits_max_, unsigned radix_ = 2, bool end_ = !(radix_ <= radix_max_)> struct
 max_digits_test_do {
	static void do_it() {
...
template<unsigned radix_max_, unsigned digits_max_, unsigned radix_> struct
 max_digits_test_do<radix_max_, digits_max_, radix_, true> {
	static void do_it() {}
	};

template<unsigned radix_max_, unsigned digits_max_> void max_digits_test() {
