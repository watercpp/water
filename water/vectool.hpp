...
namespace _ { namespace vectools {
    ...
    template<bool destruct_>
    struct destruct {
        template<typename value_>
        static void do_it(value_* v) noexcept {
            v->~value_();
        }
        template<typename value_>
        static void do_it(value_* b, value_* e) noexcept {
            while(b != e) (--e)->~value_();
        }
    };
    ...
    struct destruct<false> {
        template<typename value_>
        static void do_it(value_*) noexcept {}
        template<typename value_>
        static void do_it(value_*, value_*) noexcept {}
    };
    
    
    template<typename value_, bool destruct_>
    struct auto_destruct {
        value_ *b, *e;
    ...
    template<typename value_, bool memset_ = sizeof(value_) == 1>
    struct fill {
...
template<typename value_, bool destruct_>
struct vectool<value_, destruct_, true>
{
